...
public class BalanceDaoImpl implements BalanceDao {
    ...
    public List<Balance> getBalance(String userId) {
        try (org.sql2o.Connection conn = sql2o.open()) {
            ...
            return conn.createQuery("select * from balance where \"userId\" = :userid")
    ...
    @Override
    public String topUpBalance(int amount, BankType type, String userId) {
        try (org.sql2o.Connection connection = sql2o.open()) {
            connection.createQuery(
                    "update balance set amount = (amount + :amount) where \"userId\" = :userid "
                        + "and type = :type")
    ...
    public String inputBalance(String userId, BankType type) {
        try (org.sql2o.Connection connection = sql2o.open()) {
            ...
            connection.createQuery(
                    "insert into balance (\"balanceId\",\"type\", \"userId\") VALUES (:balanceId,"
                        + " :type, :userId)")
                .addParameter("type", type)
